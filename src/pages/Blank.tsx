...
export default function Blank() {
  return (
    <div>
      <PageMeta
        title="Mediconnect | Medical Dashboard"
        description="This is the Mediconnect Medical Dashboard page for managing patient records, appointments, and healthcare analytics."
      />
